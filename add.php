...
<br>
<div align="center">
<h1 align="center">Add Patient</h1><br><br>
    <form method="POST" action="add1.php">
        <table align="center">
          <tr><td><h5>Name : </h5></td>
            <td>&nbsp;<input type="text" name="name" required="yes"></td></tr>
          <tr><td><br></td></tr>
          <tr><td><h5>Email:</h5></td>
            <td>&nbsp;<input type="email" name="email" required="yes"></td></tr>
          <tr><td><br></td></tr>
          <tr><td><h5>Phone:</h5></td>
            <td>&nbsp;<input type="number" name="phone" required="yes" ></td></tr>
          <tr><td><br></td></tr>
          <tr><td><h5>Password:</h5></td>
            <td>&nbsp;<input type="password" name="pass" required="yes"></td></tr>
          <tr><td><br></td></tr>
          <tr><td><br></td></tr>
          <tr><td align="center"><input type="submit" name="Login" value="Add" align="center" class="btn btn-primary"></td></tr>
        </table>
    </form>
</div>
<br><br>
